...
module.exports.run = async (client, message, args) => {   
  let embed = new Discord.RichEmbed()
    ...
    .setColor(0xFF4500)
    .setDescription("EL Pikáchu  is a bot aimed to help Pokecord players. It will tell you what Pokemon it is whenever Pokecord spawns one. As such, you no longer have to rack your brains or even search Google. Sometimes, you may just miss a rare Pokemon like this.")
    .addField("Developer", "<@559642661330485304>")
    .addField("How does it work?", "All the images from Pokecord are hashed into short strings, and stored in our database. When Pokecord spawns a Pokemon, EL PikáChu will hash it, then compare with the database and retrieve the name of the Pokemon.")
    ...
    .addField("Bot invite link", "https://discordapp.com/oauth2/authorize?client_id=589169375588909057&scope=bot&permissions=8")
    .addField("Server invite link", "https://discord.gg/U3Ykyfx")
