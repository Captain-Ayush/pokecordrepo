...
client.on('ready', () => {
  ...
  client.user.setActivity(Pokécord Helper upgraded', {type: "Streaming"});
});
                ...
                .then(hash => {
                  ...
                  if (result === undefined) {
                    embed
                      ...
                      .setDescription("Please contact the owner 고스트 라이더 Aka Ayush#1999 to add this Pokemon to the database.");
